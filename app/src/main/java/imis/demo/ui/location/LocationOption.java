		...
		startLoc.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				case R.id.radio_gcj02:
					option.setCoorType(LocUtil.CoorType_GCJ02);
					break;
				case R.id.radio_bd09ll:
					option.setCoorType(LocUtil.CoorType_BD09LL);
					break;
				case R.id.radio_bd09:
					option.setCoorType(LocUtil.CoorType_BD09MC);
					break;
				default:
					break;
				}
